...
namespace SistemaJuridico.ViewModels
{
    public partial class ProcessoDetalhesViewModel : ObservableObject
    {
        ...
        private void CarregarVerificacoes()
        {
            ...
            if (ultima == null)
            {
                _ultimaVerificacaoData = "Sem verificação";
                _ultimaVerificacaoResponsavel = "N/D";
                _ultimaVerificacaoDate = null;
            }
            else
            {
                _ultimaVerificacaoData = ultima.DataHora ?? "Sem verificação";
                _ultimaVerificacaoResponsavel = string.IsNullOrWhiteSpace(ultima.Responsavel)
                    ? "N/D"
                    : ultima.Responsavel;
